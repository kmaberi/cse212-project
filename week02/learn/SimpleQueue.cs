public class SimpleQueue {
    public static void Run() {
        ...
        // Defect(s) Found: The dequeue method was using index 1 instead of index 0.
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: The enqueue method was using Insert(0, value) instead of Add(value) to put it at the back.
